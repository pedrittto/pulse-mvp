...
export default function HelpIcon({ className = '' }: HelpIconProps) {
  ...
  return (
    <div className={`relative inline-block ${className}`}>
      ...
      {showTooltip && (
        <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-md shadow-lg whitespace-nowrap z-10 pointer-events-none">
          <div className="mb-1">
